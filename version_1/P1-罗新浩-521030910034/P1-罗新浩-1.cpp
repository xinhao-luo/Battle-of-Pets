...
void enemyAtk(istream& is, ostream& os)
{
    ...
    if(is_up(nowe, nowp)){
        ...
        u_HPdamage(nowp, Damage(nowe, nowp, 2));
        ...
        u_HPdamage(nowp, Damage(nowe, nowp, 1));
...
//enemy's next pet
PetType enemy_nextpet(istream& is, ostream& os)
{
    if(nowp.petAlive()){
        switch(nowp.getType()) {
        case W:
...
void selectSki(istream& is, ostream& os)
{
    ...
    if(n == 1){
        ...
        enemyAtk(is, os);
        e_HPdamage(nowe, Damage(nowp, nowe, 1));
        ...
        enemyAtk(is, os);
        e_HPdamage(nowe, Damage(nowp, nowe, 2));
